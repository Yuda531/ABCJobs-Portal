    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-3 mb-3">
                <div class="d-flex flex-column border rounded-3 pb-4 bg-white shadow sticky-custom">
                    <div class="col-12 border border-light rounded-3 text-center fs-1 d-flex align-items-center justify-content-center bg-primary bg-gradient text-white" style="height: 17vh; margin: 0 auto;">
                    ...
                    <a href="profile" class="btn btn-outline-primary mx-4 align-self-center">My Profile</a>
                </div>
            </div>
                        ...
                        <div class="row">
                            <div class="col-2">
                                <c:if test="${not empty jobs.imageCompany}">
                                    <img src="data:image/jpeg;base64,${jobs.getPostImageDataBase64()}" alt="Company Logo"  style="max-width: 130%; height: 90%;">
                                </c:if>
                            </div>
                        ...
                        <div class="col-lg-12">
                            <div class="card-body d-flex justify-content-around">
                                ...
                                <div class="col-lg-3 d-flex align-items-center justify-content-end">
                                    <button class="btn btn-outline-primary btn-sm follow-btn rounded-pill" type="button">Follow</button>
                                </div>
                            </div>
                            <div class="card-body d-flex justify-content-around">
                                <div class="col-lg-9">
