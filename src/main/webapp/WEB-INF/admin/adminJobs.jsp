								...
								<div class="modal-content one">
									<form action="/post-job" method="post"
										...
										<div class="modal-body">
											...
											<div class="mb-3">
												<label for="jobsRole" class="form-label">Job Role</label> <input
													type="text" class="form-control" id="jobsRole"
													name="jobsRole" />
											</div>
											<div class="mb-3">
												<label for="jobsLocation" class="form-label">Job
													Location</label> <input type="text" class="form-control"
													id="jobsLocation" name="jobsLocation" />
											</div>
											<div class="mb-3">
												<label for="postDetails" class="form-label">Job
													Details</label>
												<textarea placeholder="Job Details" class="form-control"
													id="postDetails" name="details" rows="4"></textarea>
											</div>
											<div class="mb-3">
												<label for="chooseImage" class="form-label">Choose
													Image</label> <input type="file" class="form-control"
													id="chooseImage" name="imageFile" />
											</div>
										</div>
