			...
			<div class="collapse navbar-collapse justify-content-end"
				...
				<ul class="navbar-nav sm-auto mb-2 mb-lg-0">
					<li class="nav-item"><a
						...
						href="../admin"><i class="fa fa-home" aria-hidden="true"></i></a></li>
					<li class="nav-item"><a
						class="btn btn-outline-primary mx-1 rounded-pill pe-4 ps-4"
						href="../search"><i class="fa fa-search" aria-hidden="true"></i></a></li>
					<li class="nav-item"><a
						class="btn btn-outline-danger mx-1 rounded-pill pe-4 ps-4"
						href="../logout"><i class="fa fa-sign-out" aria-hidden="true"></i></a></li>
				</ul>
			</div>
		</div>
	</nav>